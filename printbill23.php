	...
	else
	{
	  ...
	  if($type=='CS')
	  {
								   ...
								   $cust=$sqp[0]['CustomerID'];
											...
											if($packagee!="")
											{
												$sqlInsert1 = "Insert into tblInvoiceDetails(AppointmentId, Billaddress, InvoiceId,CustomerID,CustomerFullName,Email,Mobile,SubTotal,OfferAmt,Total,RoundTotal,CashAmount,TotalPayment,Flag,Membership_Amount,OfferDiscountDateTime,PendingAmount,PackageID,PackageIDFlag) values('".$appointment_id."','".$billaddress."', '".$invoiceid."','".$cust."','".$CustomerFullName."','".$email."','".$mobile."','".$sub_total."','".$offeramtt."','".$total."','".$roundtotal."','".$roundtotal."','".$totalpayment."','CS','".$membercost."','".$date."','".$totalpend."','".$packagee."','P')";
											}
											else
											{
												$sqlInsert1 = "Insert into tblInvoiceDetails(AppointmentId, Billaddress, InvoiceId,CustomerID,CustomerFullName,Email,Mobile,SubTotal,OfferAmt,Total,RoundTotal,CashAmount,TotalPayment,Flag,Membership_Amount,OfferDiscountDateTime,PendingAmount) values('".$appointment_id."','".$billaddress."', '".$invoiceid."','".$cust."','".$CustomerFullName."','".$email."','".$mobile."','".$sub_total."','".$offeramtt."','".$total."','".$roundtotal."','".$roundtotal."','".$totalpayment."','CS','".$membercost."','".$date."','".$totalpend."')";
											}
...
///////////////////////////////////////////////////////////////////////////////////
	   ...
	   elseif($type=='C')
	  {
													  ...
													  if($packagee!="")
														{
															$sqlInsert1 = "Insert into tblInvoiceDetails(AppointmentId, Billaddress, InvoiceId,CustomerID,CustomerFullName,Email,Mobile,SubTotal,OfferAmt,Total,RoundTotal,CardAmount,TotalPayment,Flag,Membership_Amount,OfferDiscountDateTime,PendingAmount,PackageID,PackageIDFlag) values('".$appointment_id."','".$billaddress."', '".$invoiceid."','".$cust."','".$CustomerFullName."','".$email."','".$mobile."','".$sub_total."','".$offeramtt."','".$total."','".$roundtotal."','".$roundtotal."','".$totalpayment."','C','".$membercost."','".$date."','".$totalpend."','".$packagee."','P')";
														}
														else
														{
...
///////////////////////////////////////////////////////////////////////////////////
	  ...
	  elseif($type=='BOTH')
	  {
													   ...
													   if($packagee!="")
														{
															   $sqlInsert1 = "Insert into tblInvoiceDetails(AppointmentId, Billaddress, InvoiceId,CustomerID,CustomerFullName,Email,Mobile,SubTotal,OfferAmt,Total,RoundTotal,CashAmount,TotalPayment,Flag,CardAmount,Membership_Amount,OfferDiscountDateTime,PendingAmount,PackageID,PackageIDFlag) values('".$appointment_id."','".$billaddress."', '".$invoiceid."','".$cust."','".$CustomerFullName."','".$email."','".$mobile."','".$sub_total."','".$offeramtt."','".$total."','".$roundtotal."','".$cashboth."','".$totalpayment."','BOTH','".$cardboth."','".$membercost."','".$date."','".$totalpend."','".$packagee."','P')";
															
														}
														else
														{
															   $sqlInsert1 = "Insert into tblInvoiceDetails(AppointmentId, Billaddress, InvoiceId,CustomerID,CustomerFullName,Email,Mobile,SubTotal,OfferAmt,Total,RoundTotal,CashAmount,TotalPayment,Flag,CardAmount,Membership_Amount,OfferDiscountDateTime,PendingAmount) values('".$appointment_id."','".$billaddress."', '".$invoiceid."','".$cust."','".$CustomerFullName."','".$email."','".$mobile."','".$sub_total."','".$offeramtt."','".$total."','".$roundtotal."','".$cashboth."','".$totalpayment."','BOTH','".$cardboth."','".$membercost."','".$date."','".$totalpend."')";
														}
													  if ($DB->query($sqlInsert1) === TRUE) 
														{
															$last_id = $DB->insert_id;		//last id of tblCustomers insert
