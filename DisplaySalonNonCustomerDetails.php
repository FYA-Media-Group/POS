						...
						<div class="panel">
							<div class="panel-body">
								...
								<div class="example-box-wrapper">
											...
											<div class="panel-body">
												<h4 class="title-hero"><center>List of Non Visting Customer | NailSpa</center></h4>
...
// Create connection And Write Values
  $DB = Connect();
    $ct=0;
									...
									if($strStore!='0')
										{
											$stqytq=select("distinct(CustomerID)","tblAppointments","StoreID='$strStore' and AppointmentDate<='".$n5_daysAgot."' and AppointmentDate>='2017-02-01' and NonCustomerCommentType!='0' and NonCustomerRemark!=''");
											// $Products="Select (SELECT count(Distinct ProductID) FROM `tblStoreProduct` where StoreID='$strStoreID') as TotalProducts";
