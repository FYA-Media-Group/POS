...
?>				
			...
			<div class="form-group"><label class="col-sm-3 control-label">Products<span>*</span></label>
				...
				<select class="form-control required" name="Products[]" multiple id="Products" style="height:200pt; width=200pt;">
...
<?
	...
	{
		$sql = "SELECT ProductID FROM tblProductsServices WHERE CategoryID='$catt' and ServiceID='$test[$i]'";
