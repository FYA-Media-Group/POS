...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Membership+Offer Sold| Nailspa";
	$strDisplayTitle = "Membership+Offer Sold| Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "DisplayMembershipOffer.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
												...
												<div class="example-box-wrapper">
												 <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="datatable-example" width="80%">
																				...
																				<tr>
																				    ...
																				    <tbody>
																		<?php
                                                       $sql="Select * from tblInvoiceDetails WHERE  Date(OfferDiscountDateTime)>='$First' and Date(OfferDiscountDateTime)<='$Last'";
														//echo  $sql;
																$RS = $DB->query($sql);
