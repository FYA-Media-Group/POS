...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Petty Cash For All Store | Nailspa";
	$strDisplayTitle = "Petty Cash For All Store | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "ViewPettyAll.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<head>
	...
	<?php require_once("IncPettyCashBarChart.fya"); ?>
