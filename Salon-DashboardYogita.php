...
$DB=Connect();
	...
	// echo $insertopen."<br>";
		...
		if($strCloseTime=='0000-00-00 00:00:00' && $strOpenTime!='0000-00-00 00:00:00')
		{
			...
			$suit=date('H:i',strtotime($SuitableAppointmentTimet));
			$new_time=date('H:i',strtotime($SuitableAppointmentTimet.'- 1 hour'));
			$new_timett=date('H:i',strtotime($SuitableAppointmentTimet.'-30 minute'));
									   ?>
...
?>													
												 ...
												 if($new_timett<$suit)
												 {
													 ...
													 <td style="text-aling:center;">
																				<a class="btn btn-link disabled" href="Salon-Dashboard.php?confirm=<?=$getUID?>">Confirm</a>
																		&nbsp;&nbsp;/<a class="btn btn-link disabled" href="ManageAppointments.php?uid=<?=$getUID?>">Re-schedule</a>
																		&nbsp;&nbsp;/<a class="btn btn-link disabled" href="ManageAppointments.php?cid=<?=$getUID?>">Cancel</a>
																		</td>
																		<?php
												 }
												 elseif($new_time<=$suit && $new_time>=$suit)
												 {
													 ?>
													 <td style="text-aling:center;">
																				<a class="btn btn-link" href="Salon-Dashboard.php?confirm=<?=$getUID?>">Confirm</a>
																		&nbsp;&nbsp;/<a class="btn btn-link" href="ManageAppointments.php?uid=<?=$getUID?>">Re-schedule</a>
																		&nbsp;&nbsp;/<a class="btn btn-link" href="ManageAppointments.php?cid=<?=$getUID?>">Cancel</a>
																		</td>
													 <?php
												 }
												 ?>
