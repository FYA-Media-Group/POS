...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Pending Card Reconciliation | Nailspa";
	$strDisplayTitle = "Pending Card Reconciliation  | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "DisplayPendingCardReconciliationaudit.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
