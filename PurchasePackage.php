...
<?php
	$strPageTitle = "Purchase Package | NailSpa";
	$strDisplayTitle = "Purchase Package for NailSpa";
	$strMenuID = "10";
	$strMyTable = "tblAppointments";
	$strMyTableID = "AppointmentID";
	$strMyField = "AppointmentDate";
	$strMyActionPage = "PurchasePackage.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if($strStep=="book")
		{
		    ...
		    $packagelist=implode(",",$packageid);
				...
				$strAppointmentCheckOutTime."', '".$strAppointmentOfferID."', '1','0','".$packagelist."')";
					}
					else
					{
							$sqlInsert = "INSERT INTO tblAppointments (CustomerID, StoreID, AppointmentDate, SuitableAppointmentTime, AppointmentCheckInTime, AppointmentCheckOutTime, AppointmentOfferID, Status,FreeService,PackageID,ValidPackageDate) VALUES 
				('".$strCustomerID."', '".$strStoreID."', '".$strAppointmentDate1."', '".$pqr."', '".$pqr."', '".
				$strAppointmentCheckOutTime."', '".$strAppointmentOfferID."', '1','1','".$packagelist."')";
					}
				...
				('".$strCustomerID."', '".$strStoreID."', '".$strAppointmentDate1."', '".$pqr."', '".$pqr."', '".
				$strAppointmentCheckOutTime."', '".$strAppointmentOfferID."', '1','".$packagelist."')";
				}
			 ...
			 foreach($packageid as $pack)
			{
				$seld=select("*","tblPackages","PackageID='".$pack."'");
		        ...
		        $validpack = date('Y-m-d', strtotime($valid));
				 $sqlInsertpq = "Insert into tblAppointmentPackageValidity(AppointmentID,PackageID,ValidTill) values('".$last_idp."','".$pack."', '".$validpack."')";
				...
				for($u=0;$u<count($ServiceIDd);$u++)
					{
					  ...
					  $sqlInsert1 = "Insert into tblAppointmentsDetailsInvoice(AppointmentID, ServiceID, ServiceAmount,qty,Status,PackageService) values('".$last_idp."','".$ServiceIDd[$u]."', '".$ServiceCost."','1','1','".$pack."')";
										...
										while($row2 = $RS2->fetch_assoc())
										{
											...
											else
											{
											 ...
											 $strChargeAmt = ($percentage / 100) * $outof;
												...
												('".$last_id7."', '".$strSetName."', '".$totalamt."','".$last_idp."','3','".$pack."')";
			...
			$sqlUpdate = "UPDATE tblAppointments SET PackageID='".$packagelist."' WHERE AppointmentID='".$app_id."'";
									  ExecuteNQ($sqlUpdate);
