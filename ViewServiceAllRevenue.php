...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Service Revenue | Nailspa";
	$strDisplayTitle = "Service Revenue | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "ViewServiceAllRevenue.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<head>
	...
	<?php require_once("incpiechartserall.fya"); ?>
