...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Cancelled Appointments";
	$strDisplayTitle = "Cancelled Appointments";
	$strMenuID = "6";
	$strMyTable = "tblExpensesBalance";
	$strMyTableID = "ExpenseBalanceID";
	$strMyActionPage = "DisplayCancelledAppointments.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
$sql="Select * from tblAppointments where IsDeleted!='1' and Status='3' and Date(AppointmentDate)>=Date('".$First."') and Date(AppointmentDate)<=Date('".$Last."')";	
		$sty=select("count(AppointmentID)","tblAppointments","IsDeleted!='1' and Status='3' and Status!='0' and Date(AppointmentDate)>=Date('".$First."') and Date(AppointmentDate)<=Date('".$Last."')");
