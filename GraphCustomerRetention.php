...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Customer Retention Analysis | Nailspa";
	$strDisplayTitle = "Customer Retention Analysis | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "GraphCustomerRetention";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12" style="padding-top: 10px;">
                                                        <div class="panel mrg20T">
                                                            <div class="panel-body">
                                                                <div class="col-md-12">
                                                                   <h3 class="title-hero">Monthly Customer Retention Analysis </h3>&nbsp;&nbsp;<input type="button" id="viewcust" class="btn ra-100 btn-primary" value="View All">
																		<div class="example-box-wrapper">
