...
<?php
	$strPageTitle = "Gift Voucher Sold Report | Nailspa";
	$strDisplayTitle = "Gift Voucher Sold Report of Nailspa Experience";
	$strMenuID = "2";
	$strMyTable = "tblStoreStock";
	$strMyTableID = "StoreStockID";
	$strMyField = "";
	$strMyActionPage = "ReportMarketingGiftVoucherSold.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<?php
	...
	if(isset($_GET["toandfrom"]))
	{
		...
		if(!IsNull($from))
		{
			$sqlTempfrom = " and Date(Date)>=Date('".$getfrom."')";
		}

		if(!IsNull($to))
		{
			$sqlTempto = " and Date(Date)<=Date('".$getto."')";
		}
	}
	if(isset($_GET["toandfrom"]))
	{
								...
								<div class="example-box-wrapper">
									<div class="tabs">
										...
										<div id="normal-tabs-1">
											...
											<div class="panel-body">
												<h3 class="title-hero">List of all Gift Voucher Sold</h3>
												...
												<form method="get" class="form-horizontal bordered-row" role="form">
													...
													<div class="form-group"><label class="col-sm-3 control-label"></label>
														...
														&nbsp;&nbsp;&nbsp;
														<a class="btn btn-link" href="ReportMarketingGiftVoucherSold.php">Clear All Filter</a>
														&nbsp;&nbsp;&nbsp;
...
$DB = Connect();
	...
	$sql = "Select CustomerID,StoreID,RedemptionCode,Amount,Date from  tblGiftVouchers where 1 $sqlTempfrom $sqlTempto";
