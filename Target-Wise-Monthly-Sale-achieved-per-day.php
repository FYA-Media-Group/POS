...
<?php
	$strPageTitle = "Target Wise Monthly Sale Achieved Report | Nailspa";
	$strDisplayTitle = "Target Wise Monthly Sale Achieved Report of Nailspa Experience";
	$strMenuID = "2";
	$strMyTable = "tblStoreStock";
	$strMyTableID = "StoreStockID";
	$strMyField = "";
	$strMyActionPage = "Target-Wise-Monthly-Sale-achieved.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
											...
											<div class="panel-body">
												...
												<form method="get" class="form-horizontal bordered-row" role="form">
													...
													<div class="form-group"><label class="col-sm-3 control-label"></label>
														...
														&nbsp;&nbsp;&nbsp;
														<a class="btn btn-link" href="Target-Wise-Monthly-Sale-achieved.php">Clear All Filter</a>
														&nbsp;&nbsp;&nbsp;
