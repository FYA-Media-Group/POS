...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Content List | Nailspa";
	$strDisplayTitle = "Content List | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "DisplayContent.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<?php
	...
	// echo "In else<br>";
	$sqlstorenamedisplayd = "SELECT * FROM  tblContentApproval where Status=2";
