...
<?php
	...
	$strMyTableID = "";
	$strMyField = "";
	$strMyActionPage = "EmployeeCommission-old.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
?>
													...
													<div class="form-group"><label class="col-sm-3 control-label"></label>
														...
														&nbsp;&nbsp;&nbsp;
														<a class="btn btn-link" href="EmployeeCommission-old.php">Clear All Filter</a> &nbsp;&nbsp;&nbsp;
...
<?php				
	...
	?>
							<tr>
								<td colspan="7"><b><center>Total commission for selected period : </center></b></td>
