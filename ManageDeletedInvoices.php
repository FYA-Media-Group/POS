...
<?php
	$strPageTitle = "List of All Delete Invoices | Nailspa";
	$strDisplayTitle = "List of All Delete Invoices of Nailspa Experience";
	$strMenuID = "2";
								...
								<div class="example-box-wrapper">
									<div class="tabs">
										...
										<div id="normal-tabs-1">
											...
											<div class="panel-body">
												<h3 class="title-hero">List of All Delete Invoices</h3>
...
where tblInvoiceDetails.AppointmentId!='NULL' and tblAppointments.IsDeleted='1'";
