...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Membership+Offer | Nailspa";
	$strDisplayTitle = "Membership+Offer | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpensesBalance";
	$strMyTableID = "ExpenseBalanceID";
	$strMyActionPage = "DisplayMembershipOfferSold.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
$DB = Connect();
	...
	?>
					...
					<div class="example-box-wrapper">
						<div class="fa-hover">	
								<a class="btn btn-primary btn-lg btn-block" href="DisplayMembershipOfferSold.php"><i class="fa fa-backward"></i> &nbsp; Go back to <?=$strPageTitle?></a>
							</div>
							</br>
						<div class="tabs">
				...
				<!--Manage Tab Start-->
				                        <ul>
												...
												<li><a href="#normal-tabs-1" title="Tab 1">Membership</a></li>
												<li><a href="#normal-tabs-3" title="Tab 2">Offer</a></li>
...
?>
									...
									<div id="normal-tabs-3">
										<span class="form_result">&nbsp; <br></span>
											...
											<div class="panel-body">
												<h3 class="title-hero">List of Offer Sold | Nailspa</h3>
									
												
												
												<div class="example-box-wrapper">
													<table id="datatable-responsiveuu" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
														<thead>
															<tr>
																<th>Sr.No</th>
																<th>Store Name</th>
