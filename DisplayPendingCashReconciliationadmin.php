...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Pending Cash Reconciliation | Nailspa";
	$strDisplayTitle = "Pending Cash Reconciliation  | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "DisplayPendingCashReconciliationadmin.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
