...
<?php
	...
	else
	{
		    ...
		    $sqlUpdate2 = "UPDATE tblAppointments SET NonCustomerRemark='".$comment."',NonCustomerCommentType='".$typecomment."' WHERE AppointmentID='".$app."'";
			...
			$strBody = $msg;
		    $strbody1="<html><head><title>Non Visiting Customer</title></head><body> $strBody </body></html>";
