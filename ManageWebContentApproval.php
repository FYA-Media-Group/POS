...
<?php
	$strPageTitle = "Web Content Management | Nailspa";
	$strDisplayTitle = "Manage Web Content Nailspa";
	$strMenuID = "2";
	$strMyTable = "tblContentApproval";
	$strMyTableID = "ContentApprovalID";
	$strMyField = "";
	$strMyActionPage = "ManageWebContentApproval.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
// code for not allowing the normal admin to access the super admin rights	
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if($strStep=="add")
		{
			...
			$InsertContent="Insert into tblContentApproval(Heading, Content, Type, Status) VALUES ('".$strHeading."','".$Content."','1','1')";
...
if((isset($_GET["sid"])))
{
	...
	echo("<script>location.href='ManageWebContentApproval.php';</script>"); 
...
$DB = Connect();
$sql = "SELECT * FROM $strMyTable where Type=1 order by $strMyTableID desc";
