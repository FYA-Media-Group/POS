...
<?php
	...
	$strMyActionPage = "DisplayCustomerRemarks.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
?>
													...
													<div class="form-group"><label class="col-sm-3 control-label"></label>
														...
														&nbsp;&nbsp;&nbsp;
														<a class="btn btn-link" href="DisplayCustomerRemarks.php">Clear All Filter</a>
														&nbsp;&nbsp;&nbsp;
...
// Create connection And Write Values
  $DB = Connect();
									    ...
									    $Productst="Select * from tblCustomerRemarks where StoreID='".$store."' and CommentType!='0'";
										$selpqtyPq=select("count(AppointmentID) as cntapp","tblCustomerRemarks","StoreID='".$store."' and CommentType!='0'");
										$sercount=$selpqtyPq[0]['cntapp'];
										}
										else
										{
											$Productst="Select * from tblCustomerRemarks where StoreID!='0' and CommentType!='0'";
												$selpqtyPq=select("count(AppointmentID) as cntapp","tblCustomerRemarks","StoreID!='0' and CommentType!='0'");
										$sercount=$selpqtyPq[0]['cntapp'];
										}
