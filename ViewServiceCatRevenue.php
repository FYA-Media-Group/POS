...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Service Category Base Revenue | Nailspa";
	$strDisplayTitle = "Service Category Base Revenue | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "ViewServiceCatRevenue.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<head>
	...
	<?php require_once("incpiechartsercat.fya"); ?>
