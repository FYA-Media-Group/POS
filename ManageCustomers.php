...
/* 						$sqlInsertpo = "INSERT INTO tblAppointmentAssignEmployee(AppointmentID, ServiceID, MECID, Commission) VALUES
						('".$last_id2."', '".$ServiceID."', '0', '0')";
									...
									<div class="tabs">
										...
										<div id="normal-tabs-1">
											...
											<div class="panel-body">
												...
												<div class="example-box-wrapper">
												<a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=A">
															<div class="ripple-wrapper">A
															</div>
														</a>&nbsp;
													   <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=B">
															<div class="ripple-wrapper">B
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=C">
															<div class="ripple-wrapper">C
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=D">
															<div class="ripple-wrapper">D
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=E">
														  ...
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=F">
															<div class="ripple-wrapper">F
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=G">
															<div class="ripple-wrapper">G
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=H">
															<div class="ripple-wrapper">H
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=I">
															<div class="ripple-wrapper">I
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=J">
															<div class="ripple-wrapper">J
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=K">
															<div class="ripple-wrapper">K
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=L">
															<div class="ripple-wrapper">L
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=M">
															<div class="ripple-wrapper">M
															</div>
														</a>&nbsp;
														  <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=N">
															<div class="ripple-wrapper">N
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=O">
															<div class="ripple-wrapper">O
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=P">
															<div class="ripple-wrapper">P
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=Q">
															<div class="ripple-wrapper">Q
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=R">
															<div class="ripple-wrapper">R
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=S">
															<div class="ripple-wrapper">S
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=T">
															<div class="ripple-wrapper">T
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=U">
															<div class="ripple-wrapper">U
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=V">
															<div class="ripple-wrapper">V
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=W">
															<div class="ripple-wrapper">W
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=X">
															<div class="ripple-wrapper">X
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=Y">
															<div class="ripple-wrapper">Y
															</div>
														</a>&nbsp;
														 <a class="btn btn-round btn-default" href="ManageCustomers.php?Cust_type=Z">
																...
																<?php
																	...
																	foreach ($finalarray as $key => $value) 
																	{
																		...
																		else 
																		{
																			...
																			?>
																			<td><center><a class="btn btn-link font-blue" href="ManageAppointments.php?bid=<?=$EncodedID?>">Book Appointment</a> / <a class="btn btn-link font-blue" href="PurchaseGV.php?bid=<?=$EncodedID?>">Purchase GV</a> / <a class="btn btn-link font-blue" href="PurchasePackage.php?bid=<?=$EncodedID?>">Purchase Package</a></center></td>
