				...
				<div class="row">
					<span id="abc" style="display:none"></span>
						...
						<div class="panel mrg20T">
							<div class="panel-body">
							<div class="col-md-12">
									<h3 class="title-hero">Best Performing Employee <?="( ".$FromDatee." To ".$ToDatee." )"?></h3>&nbsp;&nbsp;<input type="button" id="viewempper" class="btn ra-100 btn-primary" value="View All">&nbsp;&nbsp;<input type="button" id="referemper" class="btn ra-100 btn-primary" value="Refresh">
