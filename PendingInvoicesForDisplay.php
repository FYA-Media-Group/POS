...
<?php
	$strPageTitle = "Pending Invoice | Nailspa";
	$strDisplayTitle = "Pending Invoice";
                                            ...
                                            <td>
                                                ...
                                                <tbody>
														...
														foreach($seldpdept as $val)
														{
															...
															<tr>
																<td style="LINE-HEIGHT:25px;FONT-FAMILY:Verdana,Geneva,sans-serif;COLOR:#000;FONT-SIZE:12px;FONT-WEIGHT:normal; text-align:center;"><?=$val['ServiceID']?></td>
