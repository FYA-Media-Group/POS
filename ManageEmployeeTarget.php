...
$sql="Select tblEmployeeTarget.ETID, tblEmployeeTarget.EmployeeCode, tblEmployeeTarget.TargetForMonth, tblEmployeeTarget.Year, tblEmployeeTarget.BaseTarget, tblEmployeeTarget.Week1, tblEmployeeTarget.Week2, tblEmployeeTarget.Week3, tblEmployeeTarget.Week4, tblEmployeeTarget.Week5, tblEmployees.EmployeeName from  tblEmployeeTarget Left Join tblEmployees ON tblEmployeeTarget.EmployeeCode=tblEmployees.EmployeeCode where tblEmployeeTarget.TargetForMonth='$MonthSpell' and tblEmployeeTarget.Year='$Year'";
// echo $sql;
// echo $sql;
// die();
$RS = $DB->query($sql);
...
$sql="Select tblEmployeeTarget.ETID, tblEmployeeTarget.EmployeeCode, tblEmployeeTarget.TargetForMonth, tblEmployeeTarget.Year, tblEmployeeTarget.BaseTarget, tblEmployeeTarget.Week1, tblEmployeeTarget.Week2, tblEmployeeTarget.Week3, tblEmployeeTarget.Week4, tblEmployeeTarget.Week5, tblEmployees.EmployeeName from  tblEmployeeTarget Left Join tblEmployees ON tblEmployeeTarget.EmployeeCode=tblEmployees.EmployeeCode Order By tblEmployeeTarget.ETID DESC";
// echo $sql;
// die();
$RS = $DB->query($sql);
if ($RS->num_rows > 0) 
