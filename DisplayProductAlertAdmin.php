...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Product Alert | Nailspa";
	$strDisplayTitle = "Product Alert  | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "DisplayProductAlertAdmin.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<?php
	...
	$First= date('Y-m-01');
	$Last= date('Y-m-t');
$selp=select("Stock","tblStoreProduct","1");
$checkstock=$selp[0]['Stock'];
if($checkstock<5)
{
						
	// echo "In else<br>";
	$sqlstorenamedisplayd = "select ProductID,ProductStockID,StoreID,Stock from tblStoreProduct where Stock<5";
...
?>
														...
														<tbody>
														<tr>
															<td colspan="3"><center><b>Total count in selected periods(s) : <?=$counter?></b><center></td>
