...
<?php require_once 'incFirewall.fya'; 
	...
	$strMyActionPage = "StorePendingBillReconciliation.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
where tblAppointments.IsDeleted!='1' and tblAppointments.StoreID='".$strStore."' and tblInvoiceDetails.AppointmentId!='NULL' and tblAppointments.Status='2' and tblAppointments.ApproveStatus!='1' and Date(tblInvoiceDetails.OfferDiscountDateTime)>='$First' and Date(tblInvoiceDetails.OfferDiscountDateTime)<='$Last'";
