...
$DB = Connect();
                                                        for($i=0;$i<count($iddd);$i++)
														{
																			...
																			$selpt=select("*","tblProductsServices","ProductID='".$iddd[$i]."' and StoreID='".$store."' and ServiceID='".$service."'");
																			...
																			if($Status=='1')
																			{
																				...
																				$Color=$selppp[0]['Color'];
																						...
																						$sep=select("*","tblStoreProduct","ProductStockID='".$ProductStockID."' and StoreID='".$store."'");
																						$Stock=$sep[0]['Stock'];
																						if($Stock!='0')
																						{
																							?>
																			...
																			{
																				$sep=select("*","tblStoreProduct","ProductID='".$proddid."' and StoreID='".$store."'");
																				$selppptt=select("*","tblNewProducts","ProductID='".$proddid."'");
																				$ProductName=$selppptt[0]['ProductName'];
