...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Membership Sold | Nailspa";
	$strDisplayTitle = "Membership Sold | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpensesBalance";
	$strMyTableID = "ExpenseBalanceID";
	$strMyActionPage = "DisplayMembershipSoldStore.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
$DB = Connect();
	...
	?>
					...
					<div class="example-box-wrapper">
						<div class="fa-hover">	
								<a class="btn btn-primary btn-lg btn-block" href="DisplayMembershipSoldStore.php"><i class="fa fa-backward"></i> &nbsp; Go back to <?=$strPageTitle?></a>
							</div>
							</br>
						<div class="tabs">
...
$sept2t=select("*","tblStores","StoreID='".$strStore."'");
$StoreName=$sept2t[0]['StoreName'];

$sql="Select * from tblInvoiceDetails WHERE  Date(OfferDiscountDateTime)>='$First' and Date(OfferDiscountDateTime)<='$Last' and Membership_Amount!='' and Billaddress like '%$StoreName'";
//echo $sql;
$RS = $DB->query($sql);
if ($RS->num_rows > 0) 
{
