...
<?php							
				...
				<span id="abc" style="display:none"></span>
                        <div class="col-md-8" style="padding-top: 10px;">
                            <div class="row">
                                <div class="col-md-3">
									<a href="http://pos.nailspaexperience.com/admin/ManageAppointments.php" title="Example tile shortcut" class="tile-box tile-box-shortcut btn-danger"><span class="bs-badge badge-absolute">
<?php
									$DB = Connect();
									// echo $strAdminID;
									// echo "hello";
