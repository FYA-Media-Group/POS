...
$sql = "select tblEmployees.*, tblEmployeeTarget.TargetForMonth, tblEmployeeTarget.BaseTarget 
		...
		where tblEmployees.Status='0' and tblEmployees.StoreID='$strStore'";
...
if($RS->num_rows > 0) 
{
	...
	while($row = $RS->fetch_assoc())
	{
		...
		$sqldetails = "SELECT tblAppointmentAssignEmployee.AppointmentID, tblAppointmentAssignEmployee.ServiceID, tblAppointmentsDetailsInvoice.ServiceAmount, tblAppointmentAssignEmployee.Commission, tblInvoiceDetails.OfferDiscountDateTime 
						...
						on tblAppointmentAssignEmployee.AppointmentID=tblInvoiceDetails.AppointmentId left join tblAppointments on tblAppointmentAssignEmployee.AppointmentID=tblAppointments.AppointmentID
						where tblEmployees.StoreID = '$strStore' and tblEmployees.EID='$strEID' and tblAppointmentAssignEmployee.AppointmentID!='NULL' and tblAppointments.IsDeleted!='1' and tblInvoiceDetails.OfferDiscountDateTime!='NULL' $sqlTempfrom $sqlTempto group by tblAppointmentAssignEmployee.AppointmentID";
