...
$objPHPExcel->getProperties()->setCreator("Saif Usmani")
							 ...
							 ->setTitle("Office 2007 XLSX Customer Report Document")
							 ->setSubject("Office 2007 XLSX Customer Report Document")
							 ->setDescription("Customer Report document for Office 2007 XLSX, generated using PHP.")
							 ->setKeywords("office 2007 openxml php")
							 ->setCategory("Customer Report result file");
...
$objRed = $objRichText2->createTextRun("Sr.No");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );
		 
$objRichText3 = new PHPExcel_RichText();
$objRed = $objRichText3->createTextRun("Customer Name");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );

$objRichText4 = new PHPExcel_RichText();
$objRed = $objRichText4->createTextRun("Customer Email ID");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );
		 
$objRichText5 = new PHPExcel_RichText();
$objRed = $objRichText5->createTextRun("Mobile No");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );
	 
$objRichText6 = new PHPExcel_RichText();
$objRed = $objRichText6->createTextRun("Membership Assigned");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );

$objRichText7 = new PHPExcel_RichText();
$objRed = $objRichText7->createTextRun("Gender");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );

$objRichText8 = new PHPExcel_RichText();
$objRed = $objRichText8->createTextRun("Registration Date");
$objRed->getFont()->setColor( new PHPExcel_Style_Color(PHPExcel_Style_Color::COLOR_RED  ) );
// Colour work Ends
