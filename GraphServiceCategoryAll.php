...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Service Category | Nailspa";
	$strDisplayTitle = "Service Category | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "GraphCustomerRetention.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
     ...
     $("#viewsercat").click(function()
						...
						//alert(666)
								$.ajax({
								 type:"POST",
								 data:"abc="+abc,
								 url:"DisplayServiceCategory.php",
								 success:function(res)
								{
								//alert(res)
								  if(res=='1')
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12" style="padding-top: 10px;">
                                                        <div class="panel mrg20T">
                                                            <div class="panel-body">
                                                                <div class="col-md-12">
                                                                		<h3 class="title-hero">Monthly Service Category Wise Revenues</h3>&nbsp;&nbsp;<input type="button" id="viewsercat" class="btn ra-100 btn-primary" value="View All">&nbsp;&nbsp;<input type="button" id="referemperall" class="btn ra-100 btn-primary" value="Refresh All">
																		<div class="example-box-wrapper">
