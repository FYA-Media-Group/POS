<div class="upload">
	<a class="btn btn-success btn-sm" href="downloads/UploadFormat1.xlsx">Click Here to Download the Excel Format</a><br><br>
		...
		$.ajax({
			...
			success: function ( data ) 
			{
				...
				if(data.indexOf("file-uploaded") > -1)
				{
					...
					$(".result_message_excel").html('<iframe src="ExcelDisplay1.php?v=1&fn='+filename+'" width="100%" height="600px"></iframe>');
				}
				else
				{
