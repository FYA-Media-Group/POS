...
<?php
	...
	$strMyField = "";
	$strMyActionPage = "ReportOfferMarketingSold.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
											...
											<div class="panel-body">
												...
												<form method="get" class="form-horizontal bordered-row" role="form">
													...
													<div class="form-group"><label class="col-sm-3 control-label"></label>
														...
														&nbsp;&nbsp;&nbsp;
														<a class="btn btn-link" href="ReportOfferMarketingSold.php">Clear All Filter</a>
														&nbsp;&nbsp;&nbsp;
...
$DB = Connect();
	...
	$sql = "SELECT tblAppointments.CustomerID,tblAppointments.StoreID,tblAppointments.offerid,tblAppointmentMembershipDiscount.OfferAmount,tblInvoiceDetails.OfferDiscountDateTime from tblInvoiceDetails Left Join tblAppointments on tblInvoiceDetails.AppointmentId=tblAppointments.AppointmentID Left Join tblAppointmentMembershipDiscount
