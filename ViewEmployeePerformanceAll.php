...
<?php require_once 'incFirewall.fya'; 
	$strPageTitle = "Best Performing Employee | Nailspa";
	$strDisplayTitle = "Best Performing Employee | Nailspa";
	$strMenuID = "6";
	$strMyTable = "tblExpenses";
	$strMyTableID = "ExpenseID";
	$strMyActionPage = "ViewEmployeePerformanceAll.php";
	$strMessage = "";
	$sqlColumn = "";
	$sqlColumnValues = "";
...
<head>
	...
	<?php require_once("IncBestEmployeeStore.fya"); ?>
